    ...
    >
      <Accordion label="実験の説明">
        <Text tone="tertiary" className="text-sm mb-2">
          画面の上部に商品画像をタイル状に並べた商品ページのgood実装パターンです。
        </Text>
        <Text tone="tertiary" className="text-sm">
          badパターンと比較して、ページのガタつきが発生しないことがわかります。
          <br />
          画像6枚すべてにwidth/height属性を指定しているため、ブラウザは画像の読み込み前からアスペクト比を把握して、あらかじめ画像の高さ分のスペースを計算することができます。
        </Text>
      </Accordion>
